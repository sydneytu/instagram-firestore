...
//  instagram-firestore
//
//  Created by Sydney Turner on 5/13/22.
//
...
class RegistrationController: UIViewController {
    ...
    // TODO: create custom subclass called authentication button
    ...
    @objc func handleSignUp() {
        ...
        let credentials = AuthCredentials(email: email, passowrd: password,
...
extension RegistrationController: FormViewModel {
    func updateForm() {
        ...
        signUpButton.setTitleColor(view.backgroundColor, for: .normal)
